<%@ Page Language="C#" MasterPageFile="~/UserPage.master"  AutoEventWireup="true" CodeFile="Student.aspx.cs" Inherits="Student" %>
...
<asp:Content ID="Content30" runat="server" contentplaceholderid="ContentPlaceHolder75">
    <asp:SqlDataSource ID="SqlDataSource_StudentL" runat="server" ConnectionString="<%$ ConnectionStrings:ClassManagementConnectionString %>" SelectCommand=""></asp:SqlDataSource>
    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ClassManagementConnectionString %>" SelectCommand="SELECT [cleft] FROM [Course]"></asp:SqlDataSource>
</asp:Content>
